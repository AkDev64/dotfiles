----------------------------------------------
-- baseado no https://github.com/radleylewis/nvim-lite/blob/youtube_demo/init.lua
-- --------------------------------------------
...
--vim.opt.colorcolumn = "010"                        -- Show column at 100 characters
...
--vim.opt.vim.foldexpr = "v:lua.vim.treesitter.foldexpr()" -- Use treesitter for folding
...
vim.keymap.set('n', '<leader>tt', open_file_in_tab, { desc = 'Open file in new tab' })
...
-- configuração importada do init.vim antigo
